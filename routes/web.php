...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['auth', 'verified', 'role:Admin|Sales Manager|Recon Manager'])->group(function () {
    ...
    Route::middleware(['auth', 'verified', 'role:Admin|Sales Manager|Recon Manager'])->prefix('inspection')->name('inspection.')->group(function () {
