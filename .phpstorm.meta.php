...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.sales.driver' => 'string',
            'auth.guards.sales.provider' => 'string',
            ...
            'auth.passwords.sales_teams.provider' => 'string',
            'auth.passwords.sales_teams.table' => 'string',
            'auth.passwords.sales_teams.expire' => 'integer',
            'auth.passwords.sales_teams.throttle' => 'integer',
            ...
            'broadcasting.connections.pusher.options.debug' => 'boolean',
            ...
            'filesystems.links.C:\laragon\www\salesqueue\public\storage' => 'string',
...
'edit users','approve-estimates','viewTelescope','delete',);
...
'auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider','auth.guards.sales.driver','auth.guards.sales.provider',
...
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.sales_teams.provider','auth.passwords.sales_teams.table',
'auth.passwords.sales_teams.expire','auth.passwords.sales_teams.throttle','auth.password_timeout','broadcasting.default','broadcasting.connections.reverb.driver',
...
'broadcasting.connections.pusher.options.scheme','broadcasting.connections.pusher.options.encrypted','broadcasting.connections.pusher.options.useTLS','broadcasting.connections.pusher.options.debug','broadcasting.connections.pusher.client_options',
...
'filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\salesqueue\\public\\storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'settings.auto_discover_settings','settings.discovered_settings_cache_path','concurrency.default','cors.paths','cors.allowed_methods',
...
'view.paths','view.compiled','dompdf.show_warnings','dompdf.public_path','dompdf.convert_entities',
...
'blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','sanctum.stateful','sanctum.guard',
...
'sanctum.csrf-cookie','telescope','dashboard','profile.edit',
'profile.update','profile.destroy','admin.settings.index','admin.settings.update-csv-settings','admin.users.index',
'admin.users.create','admin.users.store','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.users.verify','admin.roles.index','admin.roles.update-permissions','admin.permissions.index',
'admin.permissions.create','admin.permissions.store','admin.permissions.show','admin.permissions.edit','admin.permissions.update',
'admin.permissions.destroy','admin.settings.update','sales.perosn','sales.perosn.store',
'tokens.page','tokens.generate','tokens.active','tokens.complete','tokens.skip','token.current','appointment.records','appointment.create','appointment.form','customer.appointment.store','token.history.view',
'customer.sales.store','create.saletable','create.saleperson','store.saleperson','sales.activity.report',
...
'Tokens.tokens','activity-records.activity-records','admin.activity-log.index','admin.settings.index','admin.system-settings.index',
'appointments.create','appointments.form','appointments.index','appointments.status','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'components.application-logo','components.auth-session-status','components.button','components.button-link','components.danger-button',
'components.dropdown','components.dropdown-link','components.forms.signature-pad','components.heroicon-o-arrow-left','components.heroicon-o-document-arrow-down',
'components.heroicon-o-document-check','components.heroicon-o-document-minus','components.heroicon-o-document-plus','components.heroicon-o-document-text','components.heroicon-o-eye',
'components.heroicon-o-magnifying-glass','components.heroicon-o-pencil','components.heroicon-o-plus','components.heroicon-o-trash','components.heroicon-o-truck',
'components.heroicon-o-x-mark','components.input','components.input-error','components.input-label','components.inspection-item-image-upload',
'components.modal','components.nav-link','components.notification-dropdown','components.password-input','components.primary-button',
'components.responsive-nav-link','components.searchable-multi-select','components.secondary-button','components.select','components.shadcn.button',
'components.shadcn.icon-input','components.shadcn.input','components.shadcn.select','components.sidebar','components.signature-pad',
'components.text-input','components.ui-badge','components.ui-button','components.ui-card','components.ui-table',
'components.ui.card','components.vehicle-status-manager','dashboard','layouts.app','layouts.guest',
'layouts.navigation','layouts.partials.messages','partials.current-token','public.active-tokens','public.status',
'roles.create','roles.edit','roles.index','roles.index','sales-person-dashboard.dashboard',
'salesperson-form.create','salesperson-form.table','settings.index','tokens-history.tokens-history','users.create',
'users.edit','users.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','LOG_CHANNEL',
...
'FILESYSTEM_DISK','QUEUE_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME','MEMCACHED_HOST',
...
'AWS_USE_PATH_STYLE_ENDPOINT','PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_HOST',
'PUSHER_PORT','PUSHER_SCHEME','PUSHER_APP_CLUSTER','VITE_APP_NAME','VITE_PUSHER_APP_KEY',
'VITE_PUSHER_HOST','VITE_PUSHER_PORT','VITE_PUSHER_SCHEME','VITE_PUSHER_APP_CLUSTER',);
