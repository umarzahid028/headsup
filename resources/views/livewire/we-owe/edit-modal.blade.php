<div class="p-6">
    ...
    <form wire:submit.prevent="save">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <!-- Waiver Options (if applicable) -->
            <div>
                <div class="flex items-center mt-4">
                    <input id="has_waiver" type="checkbox" wire:model="has_waiver" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                    <label for="has_waiver" class="ml-2 block text-sm text-gray-900">{{ __('Has Waiver') }}</label>
                </div>
                <x-input-error :messages="$errors->get('has_waiver')" class="mt-2" />
            </div>

            <div>
                <div class="flex items-center mt-4">
                    <input id="waiver_signed" type="checkbox" wire:model="waiver_signed" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                    <label for="waiver_signed" class="ml-2 block text-sm text-gray-900">{{ __('Waiver Signed') }}</label>
                </div>
                <x-input-error :messages="$errors->get('waiver_signed')" class="mt-2" />
            </div>
        </div>
