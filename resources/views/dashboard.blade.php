<x-app-layout>
    ...
    @push('scripts')
        ...
        <script>
            const monthLabels = {!! json_encode($months ?? ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun']) !!};

            new ApexCharts(document.querySelector("#salesPersonChart"), {
                series: [{
                    name: 'Sales Persons',
                    data: {!! json_encode($salesGrowthChart ?? []) !!}
                }],
                chart: {
                    type: 'bar',
                    height: 250,
            ...
            new ApexCharts(document.querySelector("#soldCustomerChart"), {
                series: Object.values({!! json_encode($soldChart ?? ['Sold' => 0, 'Unsold' => 0]) !!}),
                chart: {
                    type: 'donut',
                    height: 250,
                    background: 'transparent',
                ...
                labels: Object.keys({!! json_encode($soldChart ?? ['Sold' => 0, 'Unsold' => 0]) !!}),
